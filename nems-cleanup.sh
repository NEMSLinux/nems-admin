...
#  /usr/local/bin/nems-push # Ensure all changes are saved to github before continuing
  ...
  echo "################################################################################" > /etc/nagios3/resource.cfg
  echo "# Do not edit this file here. Use the NEMS System Settings Tool web interface. #" >> /etc/nagios3/resource.cfg
  echo "################################################################################" >> /etc/nagios3/resource.cfg
  echo "\$USER1$=/usr/lib/nagios/plugins" >> /etc/nagios3/resource.cfg
